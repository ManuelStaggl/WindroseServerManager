...
public static class ReportUrlBuilder
{
    ...
    /// <summary>
    /// Builds a prefilled GitHub issue URL for Windrose+ compatibility reports.
        ...
        IReadOnlyList<string>? logTailLines)
    {
        ...
        var title = $"[Compat] Windrose+ not responding — Windrose {wv} / WP {wpv}";
        ...
        var body =
            ...
            "```\n\n" +
            "## Steps to Reproduce\n" +
            "1. Start server with Windrose+ active\n" +
            "2. Windrose+ HTTP dashboard does not respond\n\n" +
            "## Expected Behavior\n" +
